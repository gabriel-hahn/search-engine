...
describe('Images controller tests', () => {
    ...
    describe('Get image from URL', () => {
        ...
        beforeEach(() => {
            ...
            req = httpMock.createRequest({
                method: 'GET', url: '/api/image/imageByUrl', params: {
                    imageUrl: 'http://image.jpg'
                }
            });
        });
    ...
    describe('Get count by term', () => {
        ...
        beforeEach(() => {
            res = httpMock.createResponse();
            req = httpMock.createRequest({
                method: 'GET', url: '/api/image/getCountByTerm/:term', params: {
                    term: 'Brasil'
                }
            });
        });
    ...
    describe('Get results by term', () => {
        ...
        beforeEach(() => {
            res = httpMock.createResponse();
            req = httpMock.createRequest({
                method: 'GET', url: '/api/image/getByTerm/:term', params: {
                    term: 'Brasil'
                }
            });
        });
    ...
    describe('Increase clicks of a image', () => {
        ...
        beforeEach(() => {
            res = httpMock.createResponse();
            req = httpMock.createRequest({
                method: 'GET', url: '/api/image/increase', params: {
                    id: '123'
                }
            });
        });
